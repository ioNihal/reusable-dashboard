...
export default function Login() {
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-[#F7D4E9] to-[#E2E6FF] px-4 py-8 grid place-items-center">
            <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row gap-8 px-4 md:px-6 md:h-[95%]">
                <div className="bg-[#D9D9D9] w-full md:w-1/2 h-[200px] md:h-auto rounded-md shadow-sm"></div>
